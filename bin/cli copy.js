...
require('yargs')
    ...
    .options({
        ...
        'user-agent': {
            default: '',
            type: 'string',
            describe: 'Set custom user-agent. USE THIS OR \'ua\'!',
        },
        productsorttype: {
            alias: 'st',
            default: null,
            type: 'string',
            describe: 'choose one: {FEATURED="relevancerank", PRICE_HIGH_TO_LOW="price-desc-rank", PRICE_LOW_TO_HIGH="price-asc-rank", REVIEW_RANK="review-rank"]'
        },
        ua: {
            default: null,
            type: 'string',
